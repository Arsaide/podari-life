...
export const metadata: Metadata = {
    title: 'О фонде «Подари жизнь» | фонд «Подари жизнь»',
    description: 'Откройте для себя наши начинания, достижения и важные моменты, ' +
        'которые сделали нас тем, что мы есть сегодня. Исследуйте наше прошлое, ' +
        'понимайте наше настоящее и присоединяйтесь к нам в стремлении создать ' +
        'обнадеживающее будущее для детей, нуждающихся в помощи.',
    keywords: 'история фонда, достижения, социальная ответственность, детская медицина, социальная поддержка,' +
                'социальные изменения, миссия фонда, медицинская поддержка, забота о детях'
}
